...
print("# of instances where test vars > 100 : ", count)

print("\nSince there is only 1 instance where test # variables > 100 (max # of variables in train), we clip the specific instance to match 100 variables")
